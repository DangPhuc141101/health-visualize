...
const SecondaryY_Axis = (props) => {
    ...
    const handleClickDown = (e, index) => {
      ...
      const handleDeleted = (e, index) => {
        props.handleDeletedSecondaryY_Axis(e);
      }

  return (
    <div>
    <InputGroup.Text id="basic-addon1">Secondary y-axis</InputGroup.Text>
    <div 
    id='dest_copy' 
    onDrop={(e) => props.drop_handler_SecondaryY_Axis(e)} 
    onDragOver={(e) => props.dragover_handler(e)}
    className='secondary_Y_Axis'
    >
    {props.secondaryY_Axis != 0 ? 
            <div>
              {props.secondaryY_Axis.map((e, index) =>
                <ul key={index} >
...
export default SecondaryY_Axis